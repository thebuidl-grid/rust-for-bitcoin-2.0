...
fn parse_public_key(hex: &str) -> LabResult<PublicKey> {
    PublicKey::from_str(hex).map_err(|e| LabError::InvalidKey(e.to_string()))
}

fn parse_script(hex: &str) -> LabResult<ScriptBuf> {
