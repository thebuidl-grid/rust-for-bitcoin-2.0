...
pub fn transaction_weight(stripped_size: u64, total_size: u64) -> LabResult<u64> {
    ...
    stripped_size
        ...
        .ok_or_else(|| crate::error::LabError::InvalidSize("weight calculation overflow".to_owned()))
}
...
pub fn fee_sats(vbytes: u64, feerate_sat_vb: u64) -> LabResult<u64> {
    vbytes
        ...
        .ok_or_else(|| crate::error::LabError::InvalidSize("fee calculation overflow".to_owned()))
}
...
pub fn compare_fees(
    ...
    let savings_sats = legacy_fee_sats
        ...
        .ok_or_else(|| crate::error::LabError::InvalidSize("savings calculation overflow".to_owned()))?;
