...
pub fn build_p2pkh_script_pubkey(public_key_hex: &str) -> LabResult<String> {
    ...
    // Build the script: OP_DUP OP_HASH160 <pubKeyHash> OP_EQUALVERIFY OP_CHECKSIG
