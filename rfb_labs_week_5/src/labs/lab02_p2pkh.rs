...
pub fn p2pkh_spend_template(
    ...
    // A valid public key confirms this is unlocking data for a real key, even though the
    // signature itself is opaque bytes that only secp256k1 verification can check.
