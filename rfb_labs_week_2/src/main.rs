...
fn main() {
    ...
    // Add two inputs from the spent UTXOs of 70,000 and 50,000 sats
    ...
    // Outputs:
    // 1. Payment: 90,000 sats to bc1qreceiver
    ...
    // 2. Change: 120,000 (total input) - 90,000 (payment) - 2,000 (fee) = 28,000 sats to bc1qsender
    transaction.add_output(TxOutput {
        value: 28_000,
