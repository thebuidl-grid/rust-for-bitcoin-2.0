...
impl Transaction {
    ...
    pub fn validate(&self) -> Result<(), TransactionError> {
        ...
        //reject non-OpReturn zero outputs
        ...
        self.fee()?;
        //check for coinbase/regular input mixing and multiple coinbase inputs
        ...
        // reject mixed coinbase/regular inputs
...
impl fmt::Display for Transaction {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self.fee() {
            ...
            Err(_) => writeln!(formatter, "  Fee: INVALID (outputs exceed inputs)"),
        }
    }
}
