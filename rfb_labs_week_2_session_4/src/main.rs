...
use rfb_labs_week_2_session_4::{LibraryError, Library, Item, Member, MediaKind};
...
fn main() -> Result<(), LibraryError> {
    ...
    library.add_item(Item::new(1, "Things Fall Apart".to_string(), "Chinua Achebe".to_string(), MediaKind::Book{ pages : 1000}))?;
    library.add_item(Item::new(2, "The Richest Man in Babylon".to_string(), "George Samuel Clason".to_string(), MediaKind::Ebook{ size_kb : 1280}))?;
